...
namespace GymNotes.Entity.Migrations
{
    ...
    [Migration("20200513120113_PoprawaModeluStatystyk2")]
    partial class PoprawaModeluStatystyk2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GymNotes.Entity.Models.StatisticsDiscipline", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("StatisticsDisciplines");
                });
            ...
            modelBuilder.Entity("GymNotes.Entity.Models.StatisticsExercise", b =>
                {
                    ...
                    b.Property<int?>("StatisticsDisciplineId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("StatisticsDisciplineId");
            ...
            modelBuilder.Entity("GymNotes.Entity.Models.StatisticsDiscipline", b =>
                {
                    b.HasOne("GymNotes.Entity.Models.Statistics", null)
                        .WithMany("StatisticsDisciplines")
            ...
            modelBuilder.Entity("GymNotes.Entity.Models.StatisticsExercise", b =>
                {
                    b.HasOne("GymNotes.Entity.Models.StatisticsDiscipline", null)
                        .WithMany("StatisticsExercises")
                        .HasForeignKey("StatisticsDisciplineId");
                });
